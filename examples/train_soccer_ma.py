...
from evojax.task.ma_soccer import MultiAgentSoccer
...
def main(config):
    ...
    num_agents = 16
    max_steps = 100
    train_task = MultiAgentSoccer(
        num_agents=num_agents, test=False, max_steps=max_steps)
    test_task = MultiAgentSoccer(
    ...
    for _ in range(max_steps):
        # print(task_state.obs.shape)
        # print(task_state.obs.shape[:2])
        ...
        screens.append(MultiAgentSoccer.render(task_state))
